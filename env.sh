if [ -z "$ENGINEAI_ROBOTICS_DIR" ]; then
    ...
    export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/opt/ros/humble/lib/x86_64-linux-gnu:/opt/ros/humble/lib:$ENGINEAI_ROBOTICS_THIRD_PARTY/lib:$ENGINEAI_ROBOTICS_HARDWARE/lib:$ENGINEAI_ROBOTICS_DIR/build/_install/lib"
